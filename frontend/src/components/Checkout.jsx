...
const Checkout = () => {
  ...
  setUser({
    name: storedUser.username || "John Doe",
    email: storedUser.email || "johndoe@example.com",
    address: storedUser.address || "123 Main Street, City, Country",
  });
  setAddress(storedUser.address || "123 Main Street, City, Country");
}, []);
